            ...
            <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-3 rotate-caret  bg-gradient-dark" id="sidenav-main">
                <div class="sidenav-header">
                    ...
                    <a class="navbar-brand m-0" href="https://adwaar.com/" target="_blank">
                        ...
                        <span class="me-1 font-weight-bold text-white">ADWAAR Dashboard </span>
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse px-0 w-auto  max-height-vh-100" id="sidenav-collapse-main">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <Link to={'/virtual_reality'} class="nav-link">
                        ...
                        <li class="nav-item">
                            ...
                            <Link to={'/rtl'} class="nav-link active">
                        ...
                        <li class="nav-item">
                            <Link to={'/user_management/permission'} class="nav-link text-white">
                                ...
                                <span class="nav-link-text ms-1">إذن</span>
                            </Link>
                        </li>
                        <li class="nav-item">
